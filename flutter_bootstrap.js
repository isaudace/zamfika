(() => {
  ...
  var f = class {
    ...
    async loadEntrypoint(e) {
      let {
        entrypointUrl: n = `${w}main.dart.js`,
    ...
    async _loadWasmEntrypoint(e, n, r) {
      if (!this._scriptLoaded) {
        (this._scriptLoaded = !0), (this._onEntrypointLoaded = r);
    ...
    _createScriptTag(e, n) {
      ...
      (r.type = "application/javascript"), n && (r.nonce = n);
      let t = e;
      return (
  ...
  async function b(o, e, n) {
    ...
    let r,
      t = new Promise((i, s) => {
        r = setTimeout(() => {
          s(
            new Error(`${n} took more than ${e}ms to resolve. Moving on.`, {
              cause: b,
            })
          );
        }, e);
...
Read more: https://developer.mozilla.org/en-US/docs/Web/Security/Secure_Contexts`)),
      ...
      let {
          serviceWorkerVersion: n,
          serviceWorkerUrl: r = `${w}flutter_service_worker.js?v=${n}`,
          timeoutMillis: t = 4e3,
        } = e,
        i = r;
      this._ttPolicy != null && (i = this._ttPolicy.createScriptURL(i));
    ...
    async _waitForServiceWorkerActivation(e) {
      ...
      return new Promise((n, r) => {
        e.addEventListener("statechange", () => {
          e.state === "activated" &&
            (console.debug("Activated new service worker."), n());
        });
      });
    }
  };
      ...
      window.trustedTypes &&
        (this.policy = trustedTypes.createPolicy(n, {
          createScriptURL: function (t) {
            ...
            if (r.some((d) => d.test(s))) return i.toString();
            console.error(
    ...
    window.flutterCanvasKit
      ...
      : ((window.flutterCanvasKitLoaded = new Promise((t, i) => {
          ...
          let a = s && e.canvasKitVariant !== "full",
            d =
              e.canvasKitBaseUrl ??
              `https://www.gstatic.com/flutter-canvaskit/${r}/`;
          a && (d = `${d}chromium/`);
          let c = `${d}canvaskit.js`;
          o.flutterTT.policy && (c = o.flutterTT.policy.createScriptURL(c));
          let u = y(`${d}canvaskit.wasm`),
            l = document.createElement("script");
          (l.src = c),
            e.nonce && (l.nonce = e.nonce),
            l.addEventListener("load", async () => {
              try {
                let m = await CanvasKitInit({ instantiateWasm: u });
                (window.flutterCanvasKit = m), t(m);
              } catch (m) {
                i(m);
              }
            }),
  ...
  var _ = (o, e, n, r) =>
    new Promise((t, i) => {
      let s =
          ...
          `https://www.gstatic.com/flutter-canvaskit/${r}/`,
        a = `${s}skwasm.js`;
      o.flutterTT.policy && (a = o.flutterTT.policy.createScriptURL(a));
      let d = y(`${s}skwasm.wasm`),
        c = document.createElement("script");
      (c.src = a),
        e.nonce && (c.nonce = e.nonce),
  ...
  var g = class {
    ...
    async load({
      ...
      let s = (l) => {
        ...
        a = (l) =>
          (l.compileTarget === "dart2wasm" && !p.supportsWasmGC) ||
          (t.renderer && t.renderer != l.renderer)
            ? !1
            : s(l.renderer),
        d = i.builds.find(a);
      if (!d)
      ...
      return (
        ...
        (this.didCreateEngineInitializer =
          u.didCreateEngineInitializer.bind(u)),
        u.load(d, c, t, r, n)
      );
    }
  };
  ...
  builds: [
    {
      ...
      renderer: "auto",
      mainJsPath:
        "https://cdn.jsdelivr.net/gh/isaudace/zamfika@refs/heads/main/main.dart.js",
    },
  ],
};
...
_flutter.loader.load({
  serviceWorkerSettings: {
    serviceWorkerVersion: "110702890",
  },
});
